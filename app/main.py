...
app = FastAPI(title="NovaPay Wallet", version="0.1.0")
...
WALLETS = {
    "wal_001": {"id": "wal_001", "balance_kobo": 150000, "currency": "NGN", "owner": "user_123"},
    "wal_002": {"id": "wal_002", "balance_kobo": 50000, "currency": "NGN", "owner": "user_456"},
}
...
def get_wallet(wallet_id: str):
    ...
    if not wallet:
        REQUEST_COUNT.labels(method="GET", endpoint="/wallets/{id}", status="404").inc()
        raise HTTPException(status_code=404, detail="Wallet not found")
    REQUEST_COUNT.labels(method="GET", endpoint="/wallets/{id}", status="200").inc()
